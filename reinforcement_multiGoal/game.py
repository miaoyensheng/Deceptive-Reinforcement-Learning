...
class GameStateData:
    ...
    def getLDP(self):
        ...
        fakeGoals = self.layout.capsules
        ...
        if ldp:
            ...
            return []
        xl, yl = minLDP
        nshortest = abs(x1-x2)+abs(y1-y2)
        nldp = abs(x1-xl)+abs(y1-yl) + abs(x2-xl)+abs(y2-yl)
        return [minLDP, nshortest, nldp, startPosition, realGoal, fakeGoals]
...
class Game:
    ...
    def run( self ):
        ...
        while not self.gameOver:
            ...
            pacman_position = self.state.data.agentStates[0].getPosition()
            self.pacman_position.append(pacman_position)
