...
class QLearningAgent(ReinforcementAgent):
    ...
    def computeActionFromQValues(self, state):
        ...
        actions = [action for action in legal_actions if self.values[(position, action)] == max_value]
    ...
    def update(self, state, action, nextState, reward):
        ...
        self.values[(position, action)] = self.getQValue(state, action) + self.alpha * temporal_difference
